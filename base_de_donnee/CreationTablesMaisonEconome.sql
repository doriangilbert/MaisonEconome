...
CREATE TABLE VILLE(
   ...
   PRIMARY KEY(villeId),
   FOREIGN KEY(departementId) REFERENCES DEPARTEMENT(departementId) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE IMMEUBLE(
   ...
   FOREIGN KEY(villeId) REFERENCES VILLE(villeId) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE APPARTEMENT(
   ...
   FOREIGN KEY(immeubleId) REFERENCES IMMEUBLE(immeubleId) ON DELETE CASCADE ON UPDATE CASCADE,
   FOREIGN KEY(appartementSecurityId) REFERENCES SECURITY_APPARTEMENT(appartementSecurityId) ON DELETE CASCADE ON UPDATE CASCADE,
   FOREIGN KEY(appartementTypeId) REFERENCES TYPE_APPARTEMENT(appartementTypeId) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE PIECE(
   ...
   PRIMARY KEY(pieceId),
   FOREIGN KEY(appartementId) REFERENCES APPARTEMENT(appartementId) ON DELETE CASCADE ON UPDATE CASCADE,
   FOREIGN KEY(typePieceId) REFERENCES TYPE_PIECE(typePieceId) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE EQUIPEMENT(
   ...
   FOREIGN KEY(pieceId) REFERENCES PIECE(pieceId) ON DELETE CASCADE ON UPDATE CASCADE,
   FOREIGN KEY(typeEquipementId) REFERENCES TYPE_EQUIPEMENT(typeEquipementId) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE Consomme(
   ...
   FOREIGN KEY(equipementId) REFERENCES EQUIPEMENT(equipementId) ON DELETE CASCADE ON UPDATE CASCADE,
   FOREIGN KEY(ressourceId) REFERENCES RESSOURCE(ressourceId) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
CREATE TABLE Emet(
   ...
   FOREIGN KEY(equipementId) REFERENCES EQUIPEMENT(equipementId) ON DELETE CASCADE ON UPDATE CASCADE,
   FOREIGN KEY(substanceId) REFERENCES SUBSTANCE(substanceId) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
